...
(function() {
  ...
  Bits = (function() {
    ...
    Bits.prototype.add_bits = function(numBits, value) {
      var available_len, remaining_len, this_value, _results;
      if (value > 0xffffffff) {
      ...
      while (remaining_len > 0) {
        ...
        if (remaining_len <= available_len) {
          ...
          if (this.c_bit_index === 8) {
            this.c_byte_index++;
            _results.push(this.c_bit_index = 0);
          } else {
    ...
    Bits.prototype.lastIndexOfBit = function(bitVal) {
      var byte, col, i, _i, _j, _ref, _ref1;
      for (i = _i = _ref = this.buf.length - 1, _ref1 = this.byte_index; _ref <= _ref1 ? _i <= _ref1 : _i >= _ref1; i = _ref <= _ref1 ? ++_i : --_i) {
        byte = this.buf[i];
    ...
    Bits.prototype.get_string = function(encoding) {
      ...
      nullPos = this.buf.indexOf(0x00, this.byte_index);
      if (nullPos === -1) {
    ...
    Bits.uintToString = function(num, numBytes, encoding) {
      ...
      arr = [];
      for (i = _i = numBytes; numBytes <= 1 ? _i <= 1 : _i >= 1; i = numBytes <= 1 ? ++_i : --_i) {
    ...
    Bits.hexdump = function(buffer) {
      var byte, col, dump, endline, strline, _i, _len;
      col = 0;
      strline = '';
      dump = '';
      endline = function() {
      ...
      return process.stdout.write(dump);
    };
