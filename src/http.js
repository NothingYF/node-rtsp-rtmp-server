...
(function() {
  var DAY_NAMES, DEFAULT_SERVER_NAME, DIRECTORY_INDEX_FILENAME, GZIP_SIZE_THRESHOLD, HTTPHandler, MONTH_NAMES, WEB_DIR, Sequent, api, ejs, fs, logger, path, spawn, zeropad, zlib;
  ...
  HTTPHandler = (function() {
    function HTTPHandler(opts) {
      ...
      this.documentRoot = (_ref1 = opts != null ? opts.documentRoot : void 0) != null ? _ref1 : WEB_DIR;
    }
    ...
    HTTPHandler.prototype.handlePath = function(filepath, req, callback) {
      ...
      if (filepath === '/ping') {
        ...
        return fs.readFile("" + WEB_DIR + "/list.ejs", {
          encoding: 'utf8'
        }, (function(_this) {
    ...
    HTTPHandler.prototype.createHeader = function(params) {
      var header, protocol, statusMessage, _ref, _ref1, _ref2;
      protocol = (_ref = params.protocol) != null ? _ref : 'HTTP/1.1';
      ...
      if ((params != null ? (_ref1 = params.req) != null ? (_ref2 = _ref1.headers.connection) != null ? _ref2.toLowerCase() : void 0 : void 0 : void 0) === 'keep-alive') {
  ...
  api = {
    ...
    parseRequest: function(str) {
      var body, decodedURI, e, headerPart, headers, i, line, lines, method, params, protocol, uri, _i, _len, _ref, _ref1;
      _ref = str.split('\r\n\r\n'), headerPart = _ref[0], body = _ref[1];
      lines = headerPart.split(/\r\n/);
      _ref1 = lines[0].split(/\s+/), method = _ref1[0], uri = _ref1[1], protocol = _ref1[2];
      headers = {};
