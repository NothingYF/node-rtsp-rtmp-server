  ...
  api = {
    ...
    addGASpecificConfig: function(bits, opts) {
      ...
      if (opts.extensionFlag != null) {
        ...
        if ((_ref = opts.audioObjectType) === 1 || _ref === 2 || _ref === 3 || _ref === 4 || _ref === 6 || _ref === 7) {
    ...
    readGASpecificConfig: function(bits, opts) {
      ...
      if ((_ref = opts.audioObjectType) === 6 || _ref === 20) {
      ...
      if (info.extensionFlag) {
        ...
        if ((_ref1 = opts.audioObjectType) === 17 || _ref1 === 19 || _ref1 === 20 || _ref1 === 23) {
